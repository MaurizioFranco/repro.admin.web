...
<div class="container-fluid">
	...
	<form id="formSelectCandidates">
		...
		<input class="btn btn-danger" type="button" class="button" id="buttonDelete" value="Delete" disabled data-toggle="modal" data-target="#deleteModal" onclick="javascript:deleteCandidates();">
