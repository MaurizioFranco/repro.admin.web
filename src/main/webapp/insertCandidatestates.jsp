...
<%@include file="header.jsp" %>
	...
	<form action="./InsertCandidateStatesServlet" method="post">
  		...
  		<input type="number" name="roleid"><br>
  		
  		<label>Status Code</label><br>
  		<input type="number" name="statuscode"><br>
	
  		<label>Status Color</label><br>
  		<input type="text" name="statuscolor"><br>
  		
  		<label>Status Description</label><br>
  		<input type="text" name="stausdescription"><br>
  		
  		<label>Status Lable</label><br>
  		<input type="text" name="statuslabel"><br>
