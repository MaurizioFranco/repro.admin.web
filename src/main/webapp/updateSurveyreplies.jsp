...
<body>
	...
	<%SurveysReplies surveyReplies = SurveyRepliesService.getInstance().selectSurveyrepliesById(id);%>
	...
	<input type=text id="survey_id" placeholder="Survey_id" name="survey_id_iput" value="<%=surveyReplies.getSurveyId()%>" readonly="readonly"><br>
	<label>User ID</label><br>
	<input type=text id="user_id" placeholder="User_id" name="user_id_input" value="<%=surveyReplies.getUserId()%>" readonly="readonly"><br>
	...
	<input type=text id="answers" placeholder="Answers" name="answers_input" value="<%=surveyReplies.getAnswer()%>"><br>
